...
export const BUILDING_DEFS: Record<BuildingType, BuildingDef> = {
  nest: {
    ...
    name: 'Pet Nest',
    emoji: '🏡',
    description: 'Houses your pets. Each level increases pet capacity by 2.',
  ...
  garden: {
    ...
    name: 'Food Garden',
    emoji: '🌻',
    description: 'Grows food for your pets over time. Higher level = faster food.',
  ...
  lab: {
    ...
    name: 'Research Lab',
    emoji: '🔬',
    description: 'Reduces XP needed for evolution and unlocks special abilities.',
